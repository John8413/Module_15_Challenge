...
def recommend_portfolio(intent_request):
    ...
    if age <= 0 or age >= 65:
        return build_validation_result(
            False,
            "age",
            "Invalid age. The age should be greater than zero and less than 65."
        )
    ...
    if investment_amount < 5000:
        return build_validation_result(
            False,
            "investmentAmount",
            "Invalid investment amount. The investment amount should be greater than or equal to 5000."
        )
    ...
    if risk_level == "None":
        ...
        return build_validation_result(
            False,
            "riskLevel",
            "Invalid risk level. Please choose one of the available risk levels: None, Low, Medium, High."
        )
